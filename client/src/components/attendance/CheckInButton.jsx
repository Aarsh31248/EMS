  ...
  return (
    <div className="absolute bottom-4 right-4 flex flex-col z-1">
      <button
        ...
        disabled={loading}
        className={`w-full max-w-xs flex justify-between items-center gap-8 p-4 rounded-xl bg-linear-to-br text-white cursor-pointer ${isCheckedIn ? "from-slate-700 to-slate-900" : "from-indigo-600 to-indigo-700"}`}
      >
        {loading ? (
