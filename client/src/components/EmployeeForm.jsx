    ...
    <form onSubmit={handleSubmit} className='space-y-6 max-w-3xl animate-fade-in'>
        ...
        {/* Buttons  */}
                <div className='flex flex-col-reverse sm:flex-row justify-end gap-3 pt-2'>
                    <button type='button' className='btn-secondary cursor-pointer' onClick={() => (onCancel ? onCancel() : navigate(-1))}>
                        Cancel
                    </button>

                     <button type='submit' className='btn-primary flex items-center justify-center cursor-pointer' disabled={loading}>
