  ...
  return (
    <div className='max-w-2xl mx-auto p-8 bg-white animate-fade-in'>
      ...
      <div className='text-center'>
        <button onClick={() => window.print()} className='btn-primary print:hidden cursor-pointer'>
          Print Payslip
        </button>
      </div>
    </div>
