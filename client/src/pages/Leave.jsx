        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-8">
          {leaveStats.map((s) => (
            ...
            >
              ...
              <div className="p-3 bg-slate-100 rounded-1g group-hover:bg-indigo-50 transition-colors duration-200">
                <s.icon className="w-5 h-5 text-slate-600 group-hover:text-indigo-600 transition-colors duration-200" />
              </div>

              <div>
                <p className="text-sm text-slate-500">{s.label}</p>{" "}
                <p className="text-2x1 font-bold text-slate-900 tracking-tight">
                  {s.value}{" "}
